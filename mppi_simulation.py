...
from pympc.models.dynamics.seafloor import SeafloorFromFunction, seafloor_function_0
...
if __name__ == "__main__":
    ...
    assert time_step_prediction_factor * horizon < n_frames / 2, ('scaled horizon is larger than the buffer at the end '
